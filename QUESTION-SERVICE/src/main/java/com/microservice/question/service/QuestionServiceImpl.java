...
public class QuestionServiceImpl implements QuestionService{
	...
	@Override
	public List<Long> findRandomQuestions(String category, String difficultyLevel, int noOfQuestions) {
		return this.questiondao.findRandomQuestions(category, difficultyLevel, noOfQuestions);
	}

	@Override
	public List<Question> getAllQuestionsById(List<Long> questionid) {
		return this.questiondao.findAllById(questionid);
	}
